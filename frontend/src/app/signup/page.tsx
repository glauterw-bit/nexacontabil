    ...
    <div className="min-h-screen bg-page flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-tx-strong">Criar conta</h1>
          <p className="text-tx-muted text-sm mt-1">Comece gratuitamente no DomoSYS</p>
        </div>
        ...
        <div className="bg-card border border-line rounded-xl shadow-pop p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-tx mb-1.5">Nome completo</label>
              <input
                type="text"
                value={form.name}
                onChange={set('name')}
            ...
            <div>
              <label className="block text-sm font-medium text-tx mb-1.5">Confirmar senha</label>
              <input
                type={showPass ? 'text' : 'password'}
                value={form.confirm}
        ...
        <p className="text-center text-sm text-tx-muted mt-6">
          Já tem conta?{' '}
          <Link href="/login" className="text-acao font-medium hover:underline transition-colors">
            Entrar
          </Link>
        </p>
      </div>
